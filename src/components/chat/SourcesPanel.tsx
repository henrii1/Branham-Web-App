  ...
  return (
    <div className="flex h-full items-center justify-center p-4">
      <div className="max-w-sm rounded-[24px] border border-zinc-200 bg-[var(--surface-base)] px-6 py-7 text-center shadow-sm dark:border-zinc-700">
        ...
        <p className="font-display text-xl text-foreground">Passages</p>
        <p className="mt-2 text-sm leading-relaxed text-zinc-500 dark:text-zinc-400">
          Sermon passages retrieved for your question will appear here. For the
          most relevant results, ask one topic per chat.
        </p>
      </div>
    </div>
  );
